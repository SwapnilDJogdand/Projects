...
public class Destination extends JFrame implements Runnable {
    ...
    public Destination() {
        ...
        ImageIcon i1 = new ImageIcon(ClassLoader.getSystemResource("travel/managment/system/icons/destination3.jpg"));   //dest1.jpeg
        ...
        ImageIcon i4 = new ImageIcon(ClassLoader.getSystemResource("travel/managment/system/icons/dest1.jpg"));

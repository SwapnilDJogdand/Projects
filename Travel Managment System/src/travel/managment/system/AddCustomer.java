...
public class AddCustomer extends JFrame implements ActionListener{
    ...
    AddCustomer(String username){
        ...
        ImageIcon i1 = new ImageIcon(ClassLoader.getSystemResource("Travel Managment System\\src\\travel\\managment\\system\\icons\\addcontact.png"));  //"travel/managment/system/icons/newcustomer.jpg"
        ...
        try{
            Conn c = new Conn();
            ResultSet rs = c.s.executeQuery("select * from account where username = '"+username+"'");  // '"+username+"'"
           while(rs.next()){
    ...
    public void actionPerformed(ActionEvent ae){
        ...
        else if(r2.isSelected()){   // r2  otherwise r1
            radio = "Female";
        }

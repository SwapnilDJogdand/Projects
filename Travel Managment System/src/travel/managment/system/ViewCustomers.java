...
public class ViewCustomers extends JFrame implements ActionListener{
    ...
    ViewCustomers(String username){
        setBounds(280,50,950,625);  // 280,50,850,625
       ...
       JLabel l11 = new JLabel("");
        ...
        b2.setBounds(220,480,100,25);  //320,380,100,25
        b2.addActionListener(this);
        add(b2);
        
         
        ImageIcon i1 = new ImageIcon(ClassLoader.getSystemResource("Travel Managment System\\src\\travel\\managment\\system\\icons\\document_view.png"));
        Image i2 = i1.getImage().getScaledInstance(500, 200, Image.SCALE_DEFAULT); // 620,200
        ImageIcon i3 = new ImageIcon(i2);
        JLabel l10 = new JLabel(i3);
        l10.setBounds(20, 300, 1300, 300); //20, 400, 600, 200
        add(l10);

...
ForgotPassword(){
   ...
   ImageIcon i1 = new ImageIcon(ClassLoader.getSystemResource("travel/managment/system/icons/loginlog.jpg"));
   ...
   ImageIcon i3 = new ImageIcon(i2);
    ...
    add(l6);   
     ...
     JLabel l13 = new JLabel("Forgot Password ");
         l13.setFont(new Font("Tahoma", Font.BOLD, 20));
        l13.setBounds(560,2,300,30);
